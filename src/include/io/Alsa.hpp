...
public:
    ...
    inline int get_dev_number() const {
        return device_number;
    }

    inline std::string get_dev_name() const {
        return device_name;
    }

    inline std::string get_card_name() const {
        return card_name;
    }

    inline int get_shared_card() const {
        return shared_card;
    }

    inline int get_shared_dev() const {
        return shared_dev;
    }
